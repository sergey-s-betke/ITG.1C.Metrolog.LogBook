...
\begin{document}
	...
	\@nameuse{ГОСТ2.612@Формуляр@Изделие@1@Наименование}

	\@nameuse{ГОСТ2.612@Формуляр@Изделие@2@Наименование}

	\@nameuse{ГОСТ2.612@Формуляр@Изделие@3@Наименование}
	
	\@nameuse{ГОСТ2.612@Формуляр@ЕдиницаИзмерения}
