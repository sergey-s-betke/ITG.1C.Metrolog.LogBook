\documentclass[twoside]{gost2.105}
...
\begin{document}
	...
	Этот раздел должен содержать указания для обслуживающего персонала по эксплуатации изделия и правила
	заполнения и ведения формуляра.
	
	\subsection{Эксплуатация изделия}
	
	Перед эксплуатацией изделия необходимо внимательно изучить эксплутационную документацию на изделие.
	
	\subsection{Правила заполнения и ведения формуляра}
	
	\paragraph{} Формуляр должен постоянно находится с изделием.
	
	\paragraph{} Не допускаются записи в формуляре карандашом, смыющимися чернилами. Не допускаются подчистки.
	Неправильная запись должна быть аккуратно зачёркнута и рядом (в следующей строке) внесена новая запись.
	
	Новые записи следует заверять подписью лица, ответственного за эксплуатацию изделия.
	После подписи следует указать фамилию и инициалы ответственного лица (вместо подписи допускается
	проставлять личный штамп).
	
	При передаче изделия на другое предприятие итоговые записи по наработке следует заверить печатью
	предприятия, передающего изделие.
