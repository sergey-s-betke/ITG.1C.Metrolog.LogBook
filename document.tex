...
\begin{document}
	...
	\subparagraph{} Перед эксплуатацией изделия необходимо внимательно изучить
	эксплутационную документацию на изделие, в частности - Руководство по эксплуатации\todo{Необходима подстановка обозначения руководства и его наимения}.
	...
	\subparagraph{} Формуляр должен постоянно находится с изделием.
	
	\subparagraph{} Не допускаются записи в формуляре карандашом, смыющимися чернилами. Не допускаются подчистки.
	...
	наработке следует заверить печатью предприятия, передающего изделие.
