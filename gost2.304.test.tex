...
\begin{document}
  ...
  \makeatletter
  \f@family\,\@roman{4}\, \eskdfont \f@family\,\@roman{4}\,\@roman{6}\,\@roman{12}

  \eskdfontsize{1.8mm}\selectfont
  Tiny 999 \bfseries Tiny 999 - должны быть одинаково утолщёнными (1.8 мм - допустим только для шрифта Б)
